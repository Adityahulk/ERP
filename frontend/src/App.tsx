...
import BarcodeRegistryDashboard from '@/pages/barcode/BarcodeRegistryDashboard';
import BarcodeTestPage from '@/pages/barcode/BarcodeTestPage';
...
import WhatsappHub from '@/pages/parties/WhatsappHub';
  ...
  return (
    <Routes>
      ...
      <Route element={<ProtectedRoute><TenantGate><AppLayout /></TenantGate></ProtectedRoute>}>
        ...
        <Route path="/barcode/registry" element={<RoleGate allowed={['admin', 'manager']}><BarcodeRegistryDashboard /></RoleGate>} />
        <Route path="/barcode/test" element={<RoleGate allowed={['admin', 'manager']}><BarcodeTestPage /></RoleGate>} />
        ...
        <Route path="/whatsapp" element={<RoleGate allowed={['admin', 'manager']}><WhatsappHub /></RoleGate>} />
