  ...
  try {
    ...
    const result = await query(
      `SELECT u.id, u.name, u.email, u.phone, u.role, u.avatar_url, u.company_id,
              ...
              c.default_due_days, c.currency, c.default_currency, c.enabled_currencies, c.timezone,
    ...
    res.json(success({
      ...
      company: {
        ...
        default_due_days: r.default_due_days, currency: r.currency, default_currency: r.default_currency,
        enabled_currencies: r.enabled_currencies, timezone: r.timezone,
