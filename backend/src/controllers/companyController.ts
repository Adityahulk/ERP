  ...
  if (field === 'print_settings') {
    ...
    const normalized = {
      ...
      thermal: {
        ...
        page_size: ['2_inch', '3_inch', '4_inch', 'custom'].includes(String(thermal.page_size)) ? String(thermal.page_size) : '3_inch',
        custom_page_size: Math.max(40, Math.min(100, Number(thermal.custom_page_size ?? 48) || 48)),
        printing_type: String(thermal.printing_type) === 'image' ? 'image' : 'text',
        ...
        show_party: thermal.show_party !== false,
        show_item_amount: thermal.show_item_amount !== false,
        show_item_rate: thermal.show_item_rate === true,
        show_subtotal: thermal.show_subtotal !== false,
        show_discount: thermal.show_discount !== false,
        show_tax_columns: thermal.show_tax_columns === true,
        show_round_off: thermal.show_round_off !== false,
        ...
        cashier_show_rate: thermal.cashier_show_rate !== false,
        cashier_show_discount: thermal.cashier_show_discount !== false,
        cashier_show_tax: thermal.cashier_show_tax !== false,
        cashier_show_stock: thermal.cashier_show_stock !== false,
        cashier_show_line_total: thermal.cashier_show_line_total !== false,
        cashier_show_bill_breakdown: thermal.cashier_show_bill_breakdown !== false,
