...
function normalizeSettings(rawValue: unknown) {
  ...
  return {
    ...
    thermal: {
      ...
      custom_page_size: Math.max(40, Math.min(100, Number((thermal as any).custom_page_size ?? 48) || 48)),
      ...
      show_party: (thermal as any).show_party !== false,
      show_item_amount: (thermal as any).show_item_amount !== false,
      show_item_rate: (thermal as any).show_item_rate === true,
      show_subtotal: (thermal as any).show_subtotal !== false,
      show_discount: (thermal as any).show_discount !== false,
      show_tax_columns: (thermal as any).show_tax_columns === true,
      show_round_off: (thermal as any).show_round_off !== false,
      ...
      cashier_show_rate: (thermal as any).cashier_show_rate !== false,
      cashier_show_discount: (thermal as any).cashier_show_discount !== false,
      cashier_show_tax: (thermal as any).cashier_show_tax !== false,
      cashier_show_stock: (thermal as any).cashier_show_stock !== false,
      cashier_show_line_total: (thermal as any).cashier_show_line_total !== false,
      cashier_show_bill_breakdown: (thermal as any).cashier_show_bill_breakdown !== false,
