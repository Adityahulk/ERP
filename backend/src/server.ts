...
// Without these, ANY unhandled promise rejection or thrown error
// anywhere in the app — not just in registration — silently kills the
// entire Node process. The reverse proxy then returns 502 to whoever's
// request was in flight, with zero log trace explaining why. Log
// clearly and exit so the process manager (PM2/systemd/Docker) restarts
// cleanly instead of leaving this undiagnosable from the outside.
