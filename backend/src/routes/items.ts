...
import { uploadImportFile, uploadLabelImage } from '../services/fileUpload';
import * as labelScanCtrl from '../controllers/labelScanController';
...
router.get('/next-assign-code', ctrl.peekNextAssignCode);
router.post('/label-scan', uploadLabelImage, labelScanCtrl.scanLabelImage);
router.get('/label-scan/history', labelScanCtrl.getLabelScanHistory);
router.get('/barcode-test', labelScanCtrl.testBarcodeQuality);
